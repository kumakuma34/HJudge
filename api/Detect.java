...
public class Detect {
  ...
  public static void main(String[] args) throws Exception, IOException {
	  detectHandwrittenOcr("gs://capstone-94917.appspot.com/temp/black.jpg", System.out);  }
  ...
  public static void writeOnFile(String s, String className, String Exam, String Problem, String studentID)
  {
	  System.out.println("writeOnFile Started");
	  String path = "D:/" + className;
	  ...
	  String student = studentID.substring(0,7);
	  String array[] = s.split("\n");
	  String path1 = path + "/" + student + ".cpp";
